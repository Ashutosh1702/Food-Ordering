const dummyData = {
    ...
    menu: [
        ...
        // Additional items for offers coverage
        {
            name: "Summer Combo Deluxe",
            description: "Cheeseburger + Fries + Coke combo",
            image_url:
                "https://static.vecteezy.com/system/resources/previews/043/846/625/large_2x/burger-fries-and-cola-fast-food-menu-set-isolated-on-transparent-background-free-png.png",
            price: 29.99,
            rating: 4.6,
            calories: 980,
            protein: 32,
            category_name: "Burgers",
            customizations: ["Fries", "Coke", "Extra Cheese", "Onions"],
        },
        {
            name: "Classic Burger Combo",
            description: "Classic cheeseburger combo with fries and drink",
            image_url:
                "https://static.vecteezy.com/system/resources/previews/026/530/038/large_2x/classic-cheeseburger-fries-and-soda-combo-free-png.png",
            price: 27.99,
            rating: 4.4,
            calories: 920,
            protein: 30,
            category_name: "Burgers",
            customizations: ["Fries", "Coke", "Bacon", "Jalapeños"],
        },
        {
            name: "Mushroom Swiss Burger",
            description: "Sautéed mushrooms, Swiss cheese, toasted bun",
            image_url:
                "https://static.vecteezy.com/system/resources/previews/060/359/624/large_2x/mushroom-swiss-burger-with-lettuce-and-sesame-bun-free-png.png",
            price: 26.49,
            rating: 4.3,
            calories: 610,
            protein: 27,
            category_name: "Burgers",
            customizations: ["Mushrooms", "Onions", "Fries", "Iced Tea"],
        },
        {
            name: "BBQ Chicken Pizza",
            description: "BBQ sauce, chicken, red onions, cilantro",
            image_url:
                "https://static.vecteezy.com/system/resources/previews/058/700/847/large_2x/isolated-bbq-chicken-pizza-top-view-free-png.png",
            price: 31.99,
            rating: 4.5,
            calories: 720,
            protein: 33,
            category_name: "Pizzas",
            customizations: ["Extra Cheese", "Onions", "Olives", "Garlic Bread"],
        },
        {
            name: "Veggie Supreme Pizza",
            description: "Olives, mushrooms, peppers, onions",
            image_url:
                "https://static.vecteezy.com/system/resources/previews/057/068/221/large_2x/vegetarian-pizza-with-tomatoes-olives-and-basil-free-png.png",
            price: 28.99,
            rating: 4.2,
            calories: 680,
            protein: 22,
            category_name: "Pizzas",
            customizations: ["Olives", "Mushrooms", "Jalapeños", "Coke"],
        },
        {
            name: "Four Cheese Pizza",
            description: "Mozzarella, cheddar, parmesan, gouda",
            image_url:
                "https://static.vecteezy.com/system/resources/previews/023/742/413/large_2x/cheese-pizza-isolated-illustration-ai-generative-free-png.png",
            price: 32.49,
            rating: 4.6,
            calories: 730,
            protein: 28,
            category_name: "Pizzas",
            customizations: ["Extra Cheese", "Garlic Bread", "Iced Tea"],
        },
        {
            name: "Spicy Beef Burrito",
            description: "Beef, rice, beans, spicy salsa",
            image_url:
                "https://static.vecteezy.com/system/resources/previews/055/133/579/large_2x/spicy-beef-burrito-isolated-on-transparent-background-free-png.png",
            price: 22.99,
            rating: 4.4,
            calories: 560,
            protein: 26,
            category_name: "Burritos",
            customizations: ["Jalapeños", "Fries", "Iced Tea", "Salad"],
        },
        {
            name: "Loaded Veg Burrito",
            description: "Beans, corn, peppers, guacamole",
            image_url:
                "https://static.vecteezy.com/system/resources/previews/055/133/583/large_2x/vegetarian-burrito-with-beans-and-vegetables-free-png.png",
            price: 21.49,
            rating: 4.1,
            calories: 520,
            protein: 20,
            category_name: "Burritos",
            customizations: ["Sweet Corn", "Salad", "Coke", "Tomatoes"],
        },
        {
            name: "Mega Combo Feast",
            description: "Burger + pizza slice + soda combo feast",
            image_url:
                "https://static.vecteezy.com/system/resources/previews/062/169/853/large_2x/fast-food-combo-burger-pizza-and-soda-free-png.png",
            price: 39.99,
            rating: 4.7,
            calories: 1250,
            protein: 45,
